...
c.stat.users.push(d);b=a.parent?{name:'<a class="comment-item-pname" href="#'+b.id+'"><svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" width="200" height="200"><path d="M1.664 902.144s97.92-557.888 596.352-557.888V129.728L1024 515.84l-425.984 360.448V628.8c-270.464 0-455.232 23.872-596.352 273.28"></path></svg>'+b.dataset.name+"</a>",dom:b.querySelector(".comment-item-children"),insert:"afterbegin"}:{name:"",dom:c.dom.querySelector(".comment-list"),
